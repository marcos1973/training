 ...
 *  
 */
package com.philos.frameit.jalo;
...
/**
 * This is the extension manager of the Frameitcore extension.
 */
public class FrameitcoreManager extends GeneratedFrameitcoreManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(FrameitcoreManager.class.getName());
	 ...
	 */
	public static FrameitcoreManager getInstance()
	{
		return (FrameitcoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				FrameitcoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public FrameitcoreManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of FrameitcoreManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of FrameitcoreManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of FrameitcoreManager called, current tenant: " + getTenant().getTenantID());
		}
	}
