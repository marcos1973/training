 ...
 *  
 */
package com.philos.frameit.hmc;
...
/**
 * Provides necessary meta information about the frameitcore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class FrameitcoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(FrameitcoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public final static String RESOURCE_PATH = "com.philos.frameit.hmc.locales";
